...
#### The v.1.0.5 Windows, Linux and MAC OS X build and binary update is in progress ... please check the downloads later or build it from source for the time being.
